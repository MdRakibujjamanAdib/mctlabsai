/*
  ...
  1. Changes
    ...
    - Update admin credentials table if needed
*/

-- Drop existing policies if they exist
DO $$ 
BEGIN
  DROP POLICY IF EXISTS "Only admins can view admin credentials" ON public.admin_credentials;
  DROP POLICY IF EXISTS "Only admins can modify admin credentials" ON public.admin_credentials;
END $$;

-- Create or update admin_credentials table
...
SELECT update_admin_user('admin@mctlabs.tech', 'admin123');